...
4.  **Make your changes**. Please adhere to the coding conventions outlined in `docs/master/conventions.md`.
...
If you find a bug, please open an issue on GitHub with a detailed description, steps to reproduce, and any relevant logs or screenshots.

## Security Vulnerabilities

If you discover a security vulnerability, please send an email to reasnov.official@gmail.com instead of using the issue tracker. All security vulnerabilities will be promptly addressed.
