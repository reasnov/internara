...
The `User` module is responsible for the core identity system of Internara. it manages user accounts, administrative operations, and high-level account security.
...
### 2. Management UI
-   **[Administrative CRUD](../../versions/v0.3.x-alpha.md#31-the-user-module-administrative)**: Livewire-based index and form for account management.
