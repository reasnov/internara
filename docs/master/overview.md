...
-   **[Exception Handling Guide](exceptions.md)**: Details the philosophy, key classes, and best practices for managing exceptions consistently across the application.
