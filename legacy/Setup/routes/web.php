...
Route::prefix('setup')
    ...
    ->group(function () {
        ...
        Route::livewire('/account', AccountSetup::class)->name('setup.account');
        Route::livewire('/department', DepartmentSetup::class)->name('setup.department');
        Route::livewire('/internship', InternshipSetup::class)->name('setup.internship');
        Route::livewire('/complete', SetupComplete::class)->name('setup.complete');
    });
