...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body
        ...
        <div
            ...
            <main class="flex w-full max-w-lg flex-col-reverse lg:max-w-4xl lg:flex-row">
                <div
                    class="flex-1 rounded-ee-lg rounded-es-lg bg-white p-6 pb-12 text-[13px] leading-5 shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-ee-none lg:rounded-ss-lg lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                    ...
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        <li
                            ...
                            <span>
                                Read the
                                <a class="ms-1 inline-flex items-center space-x-1 font-medium text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]"
                                    href="https://laravel.com/docs" target="_blank">
                                    <span>Documentation</span>
                                    <svg class="h-2.5 w-2.5" width="10" height="11" viewBox="0 0 10 11"
                ...
                <div
                    class="lg:rounded-e-lg! aspect-335/376 lg:w-109.5 relative -mb-px w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:-ms-px lg:mb-0 lg:aspect-auto lg:rounded-t-none dark:bg-[#1D0002]">
                    {{-- Laravel Logo --}}
                    ...
                    {{-- Light Mode 12 SVG --}}
                    <svg class="w-md relative -ms-8 -mt-[4.9rem] max-w-none lg:-mt-[6.6rem] lg:ms-0 dark:hidden"
                    ...
                    {{-- Dark Mode 12 SVG --}}
                    <svg class="w-md relative -ms-8 -mt-[4.9rem] hidden max-w-none lg:-mt-[6.6rem] lg:ms-0 dark:block"
                        viewBox="0 0 440 376" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g
                            class="duration-750 starting:opacity-0 starting:translate-y-4 translate-y-0 opacity-100 transition-all delay-300">
                            <path
